...
<form class="inscription" action="req_inscription.php" method="post" name="inscription">
    ...
    method : indique la methode utilisé lorsqu'on clique sur submit-->
    ...
    <ul>
        ...
        <li>
            ...
            name représente le nom de de l'input et l'id représente l'id de l'input -->
            <!-- c'est lequel qui doit être égal à l'attribut for du label ?
            c'est name qui doit être égal à l'attribut for du label-->
        ...
        <li> <label for="mdp1">Mot de passe :</label>
        ...
        <li>
            ...
            Verouiller le champs à l'utilisateur -->
        </li>
        <li>
